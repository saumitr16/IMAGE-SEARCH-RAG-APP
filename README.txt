...
Mindflix_RAG_Project
====================

Mindflix_RAG_Project is an end-to-end system that demonstrates an image search and caption generation workflow. The project consists of:
...
--------------------------------
This field was necessary because ngrok changes ip address frequently in the free tier. Just input the ngrok usrl recievede after running api.py.

Step 2: Uploading Images
--------------------------------------------------------
2 options are available in this, Upload Image or Upload Text or you can do both and click on the Upload button to start uploading in the backend.

Step 3: Generating Captions
--------------------------------------------------------
Just click on the Generate Captions button and wait for suitable time (nearly 5 minutes for 50 images).

Step 3: Inserting Embeddings in the Pinecone DB
   --------------------------------------------------------
Just click on the Store Embeddings button.

Step 4: Searching
--------------------------------------------------------
You have 2 options, you can input image or text or both and the top 5 image results (image paths) with high quality meta data will be shown. 
